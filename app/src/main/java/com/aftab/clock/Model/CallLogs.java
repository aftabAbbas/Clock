...
public class CallLogs implements Serializable {
    ...
    public CallLogs(String id, String name, String phoneNumber, String callType, String callDate, String callDuration, String location, String url, boolean isRead) {
        this.id = id;
        this.name = name;
